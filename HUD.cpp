...
void HUD::draw(int width, int height, int score, bool showboard) {
...
void HUD::tick(int score, int width, int height, bool showboard) {
	this->update(score);
	this->draw(width, height, score, showboard);
}

void HUD::addNumber(Sprite* num) {
	this->numbers.push_back(num);
}

void HUD::drawNumber(int width, int height, int score) {
